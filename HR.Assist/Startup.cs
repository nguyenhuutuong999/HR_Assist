...
namespace HR.Assist
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<HRAssistDbContext>(opt =>
                opt.UseSqlServer(
            ...
            }).AddEntityFrameworkStores<HRAssistDbContext>().AddDefaultTokenProviders();
           ...
           if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "HR Assist v1");
            ...
            var db = scope.ServiceProvider.GetRequiredService<HRAssistDbContext>();
                              ...
                              RoleManager<ApplicationRole> roleManager)
        {
            ...
            if (await userManager.FindByNameAsync("phung.dinh@hrassist.com") == null)
            {
