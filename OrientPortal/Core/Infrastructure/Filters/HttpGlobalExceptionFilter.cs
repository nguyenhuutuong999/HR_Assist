...
{
    using System.Net;
    using HR_Assist.Core.Infrastructure.ActionResults;
    using HR_Assist.Core.Infrastructure.Exceptions;
    ...
    public partial class HttpGlobalExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            if (context.Exception.GetType() == typeof(HR_AssistDomainException))
            {
